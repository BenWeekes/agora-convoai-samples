...
**[Voice AI Client with Avatar & Video](./voice-client-avatar/)**
Full-featured client with AI avatar rendering and local video capture.

**[App Builder Client with Avatar & Video](./appbuilder-avatar/)**
