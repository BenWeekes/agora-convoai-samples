...
- [SDK API](#sdk-api)
  ...
  - [RTCHelper](#rtchelper)
    - [getInstance()](#static-getinstance-rtchelper-1)
    ...
    - [error event](#error)
  - [RTMHelper](#rtmhelper)
    - [getInstance()](#static-getinstance-rtmhelper-2)
    ...
    - [sendMessage()](#sendmessagemessage-string-agentuid-string-priority-append--replace-promisevoid-2)
